...
import {cloneEvent} from "@antv/g6-core/lib/util/base";
// import store from "@/store";
import type {G6Event, IG6GraphEvent} from "@antv/g6-core";
...
export default {
    ...
    onKeyDown(e: KeyboardEvent) {
        ...
        self.keydown = ALLOW_EVENTS.indexOf(code.toLowerCase()) > -1;
    },
    onKeyUp() {
